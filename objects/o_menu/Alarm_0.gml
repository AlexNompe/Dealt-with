...
glass = instance_create_layer(floor(save_var_position[0]/672)*672 + random_range(0,672),floor(save_var_position[1]/384)*384 + random_range(0,384),"Instances",o_glass_brek)
